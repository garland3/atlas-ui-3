...
_plan_cli_steps_fn = getattr(_mod.plan_cli_steps, 'fn', _mod.plan_cli_steps)
_execute_cli_plan_fn = getattr(_mod.execute_cli_plan, 'fn', _mod.execute_cli_plan)
_generate_tool_functions_fn = getattr(_mod.generate_tool_functions, 'fn', _mod.generate_tool_functions)
_plan_python_workflow_fn = getattr(_mod.plan_python_workflow, 'fn', _mod.plan_python_workflow)
